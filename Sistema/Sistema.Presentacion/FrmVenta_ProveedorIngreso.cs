...
{
    public partial class FrmVenta_ProveedorIngreso : Form
    {
        public FrmVenta_ProveedorIngreso()
        {
            InitializeComponent();
        }
        ...
        private void FrmVenta_ProveedorIngreso_Load(object sender, EventArgs e)
        {
            this.Listar();
        }
        ...
        {
            Varriables.IdProveedor = Convert.ToInt32(DgvListado.CurrentRow.Cells["ID"].Value);
            Varriables.NombreProveedor = Convert.ToString(DgvListado.CurrentRow.Cells["Nombre"].Value);
            this.Close();
        }
    }
}
