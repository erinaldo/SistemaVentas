...
namespace Sistema.Presentacion
{
    public partial class FrmVista_Cliente_Venta : Form
    {
        ...
        {
            Varriables.IdCliente = Convert.ToInt32(DgvListado.CurrentRow.Cells["ID"].Value);
            Varriables.NombreCliente = Convert.ToString(DgvListado.CurrentRow.Cells["Nombre"].Value);
            this.Close();
